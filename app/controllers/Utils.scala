...
object Utils {
  ...
  val entityNames = Map(
    ...
    "tilde" -> 732, "Alpha" -> 913, "Beta" -> 914, "Gamma" -> 915,
    ...
    "piv" -> 982, "ensp" -> 8194, "emsp" -> 8195, "thinsp" -> 8201,
  ...
  def unescape(str: String): String =
    entityExpr.replaceAllIn(str, m =>
      ...
      case decExpr(dec) =>
        new String(Character.toChars(dec.toInt))
      case name => entityNames.get(name)
        .map { codePoint =>
          new String(Character.toChars(codePoint))
        }.getOrElse(m.group(0))
      }
